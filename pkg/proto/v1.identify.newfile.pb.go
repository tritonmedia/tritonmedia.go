...
type IdentifyNewFile struct {
	...
	// season of this media
	Season               int64    `protobuf:"varint,6,opt,name=season,proto3" json:"season,omitempty"`
...
func (m *IdentifyNewFile) GetSeason() int64 {
	if m != nil {
		return m.Season
	}
	return 0
...
var fileDescriptor_f727e4443d5a0d91 = []byte{
	...
	0x4d, 0x4d, 0xc9, 0x4c, 0x84, 0x08, 0x2a, 0xad, 0x67, 0xe4, 0xe2, 0xf7, 0x84, 0xaa, 0xf7, 0x4b,
	...
	0x0e, 0x82, 0x71, 0x85, 0xc4, 0xb8, 0xd8, 0x8a, 0x53, 0x13, 0x8b, 0xf3, 0xf3, 0x24, 0xd8, 0xc0,
	0x12, 0x50, 0x5e, 0x12, 0x1b, 0xd8, 0xe1, 0xc6, 0x80, 0x00, 0x00, 0x00, 0xff, 0xff, 0xd9, 0x84,
	0x87, 0xa0, 0xea, 0x00, 0x00, 0x00,
}
